...
public class Produto implements Serializable{
    ...
    @ManyToOne    
    @JoinColumn(name = "fornecedor_nome", nullable = true)
    ...
    /**
     * @return the tp_produto
     */
    public TipoProduto getTp_produto() {
        return tp_produto;
    }

    /**
     * @param tp_produto the tp_produto to set
     */
    public void setTp_produto(TipoProduto tp_produto) {
